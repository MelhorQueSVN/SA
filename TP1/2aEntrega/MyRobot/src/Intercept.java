...
public class Intercept {
	...
	/* 
	 * 		xb :  Initial bullet position x coordinate 
	 * 		yb :  Initial bullet position y coordinate 
	 * 		xt :  Initial target position x coordinate 
	 * 		yt :  Initial target position y coordinate 
	 * 		tHeading:	Target heading 
	 * 		vt :  Target velocity 
	 * 		bPower :   Power of the bullet 
	 * 		angularVelocity_deg_per_sec  :   Angular velocity of the target
	 */
